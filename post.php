...
$post = [
    'id' => 1,
    'img_header_logo' => 'static/images/header-logo.svg',
    'title' => 'The Road Ahead',
    'subtitle' => 'The road ahead might be paved - it might not be.',
    'img' => 'static/images/main.svg',
    'img_modifier' => 'Northern lights',
    'img_footer_logo' => 'static/images/logo.svg',
    'main-text' => 'Dark spruce forest frowned on either side the frozen waterway. 
    ...
    the smile of the sphinx, a laughter cold as the frost and 
    partaking of the grimness of infallibility. It was the masterful 
    and incommunicable wisdom of eternity laughing at the futility 
    of life and the effort of life. It was the Wild, the savage, 
    frozen-hearted Northland Wild.<br>
    <br>
    ...
    was without runners. It was made of stout birch-bark, and its 
    full surface rested on the snow. The front end of the sled was 
    turned up, like a scroll, in order to force down and under the 
    bore of soft snow that surged like a wave before it. On the 
    sled, securely lashed, was a long and narrow oblong box. There 
    were other things on the sled—blankets, an axe, and a coffee-pot 
    and frying-pan; but prominent, occupying most of the space, was 
    the long and narrow oblong box.<br>
    <br>
    ...
    faces were not discernible. This gave them the seeming of ghostly 
    ...
    desolation and mockery and silence, puny adventurers bent on 
    colossal adventure, pitting themselves against the might of a 
    ...
    <body>
        <header class="header">
            <nav class="navigation-menu">
                <div class="logo">
                    <img src="<?= $post['img_header_logo'] ?>" alt="Escape.">
                </div>
                <ul>
        ...
        <main class="main">
            <div class="main-header">
                ...
                <div class="main-header-lower-top">
                    <h3><?= $post['subtitle'] ?></h3>
                </div>
            </div>
            <div class="main-img">
                <img src="<?= $post['img'] ?>" alt="<?= $post['img_modifier'] ?>">
            </div>
            <div class="main-text">
                <p><?= $post['main-text'] ?></p>
            </div>
        ...
        <footer class="footer">
            <div class="footer-background">
                <div class="footer-padding">
                    <nav class="navigation-menu">
                        <div class="logo">
                            <img src="<?= $post['img_footer_logo'] ?>" alt="Escape.">
                        </div>
                        <ul>
                        <li class="navigation-element">Home</li>
                        <li class="navigation-element">Categories</li>
